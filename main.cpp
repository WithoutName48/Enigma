...
int main()
{
    ...
    int rt1_settings, rt2_settings, rt3_settings; cin >> rt1_settings >> rt2_settings >> rt3_settings;
    ...
    string rf_settings; cin >> rf_settings;
    while(rf_settings!="0"){
    ...
    string pb_settings; cin >> pb_settings;
    while(pb_settings!="0"){
